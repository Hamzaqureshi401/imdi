...
<?php endif; ?>   
<form id="formmain" class="myform" method="post" action="<?php echo e(route('gen_inventory')); ?>" >
   <?php echo csrf_field(); ?>    
   <div class="card mb-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imdi\resources\views/admin/report/inventory.blade.php ENDPATH**/ ?>