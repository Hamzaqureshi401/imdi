         ...
         <table style="width: 100%;" id="mytb" class="table table-hover table-striped table-bordered">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td><?php if($pl->checkin_status==""|| $pl->checkin_status==NULL|| $pl->checkin_status==0): ?>
                  ...
                  <td>
                     <?php if($pl->checkin_status==""|| $pl->checkin_status==NULL || $pl->checkin_status==0): ?>
                     <b class="text-danger">Pending</b>
                     <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imdi\resources\views/admin/checkin/unlist.blade.php ENDPATH**/ ?>