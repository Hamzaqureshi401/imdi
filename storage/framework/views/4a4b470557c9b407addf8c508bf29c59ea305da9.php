                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="position-relative mb-3">
                                                        ...
                                                        <input name="upc" id="upc" placeholder="Enter 12 digit UPC" type="text" min="12" max="12" class="form-control input-mask-trigger" data-inputmask="'mask': '999999999999'" im-insert="true" inputmode="text" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative mb-3">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="position-relative mb-3">
                                                        ...
                                                        <input id="start_date" type="month" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="position-relative mb-3">
                                                        <label for="examplePassword11" class="form-label">End Month</label>
                                                        <input id="end_date" type="month" class="form-control" >
                                                    </div>
                                                </div>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imdi\resources\views/admin/product/create.blade.php ENDPATH**/ ?>