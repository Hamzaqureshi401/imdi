                            ...
                            <?php endif; ?>
                                 <table style="width: 100%;" id="mytb" class="table table-hover table-striped table-bordered">
                                     ...
                                     <tbody>
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $mc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                if($u->status=="1")
                                                {
                                                    $s="Active";
                                         ...
                                         <tr>
                                             ...
                                             <td><?php echo e($u->hi*$u->ti); ?></td>
                                             <td><?php echo e($u->alert_quantity); ?></td>
                                             <td><b class="<?php echo e($c); ?>"><?php echo e($s); ?></b></td> 
                                             <td style="text-align:center;">
                                                    <div role="group" class="btn-group-lg btn-group btn-group-toggle">
                                                        
                                                        <a class="mdb" data-bs-toggle="modal" data-bs-target="#exampleModal" data-user-id="<?php echo e($u->id); ?>">
                                                        ...
                                                        <a href="<?php echo e(route('mastercase.show', $u->id)); ?>">
                                                            <div class="font-icon-wrapper font-icon-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="View">
                                                                <i class="lnr-eye icon-gradient bg-grow-early"></i>
                                                            </div>
                                                        </a>

                                                        <a href="<?php echo e(route('changemc',$u->id)); ?>" >
                                                            <div class="font-icon-wrapper font-icon-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="<?php echo e($o); ?>">
                                                                <i class="lnr-sync icon-gradient bg-danger"></i>
                                                            </div>
                                                        </a>

                                                        
                                                        <a href="<?php echo e(route('mclabel',$u->id)); ?>">
                                                        ...
                                                        <a href="<?php echo e(route('mastercase.edit', $u->id)); ?>">
                                                    ...
                                                    <?php if(check_mc_in_rc($u->id)==0): ?>
                                                        <form class="delete" method="POST" action="<?php echo e(route('mastercase.destroy', $u->id)); ?>">
                                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imdi\resources\views/admin/mastercase/index.blade.php ENDPATH**/ ?>