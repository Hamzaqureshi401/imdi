...
<div class="tabs-animation">
 ...
 <div class="container mt-4">
        <div class="mb-3"><?php echo DNS2D::getBarcodeHTML('4445645656', 'QRCODE'); ?></div>
        <div class="mb-3"><?php echo DNS1D::getBarcodeHTML('4445645656', 'PHARMA'); ?></div>
        <div class="mb-3"><?php echo DNS1D::getBarcodeHTML('4445645656', 'PHARMA2T'); ?></div>
        <div class="mb-3"><?php echo DNS1D::getBarcodeHTML('4445645656', 'CODABAR'); ?></div>
        <div class="mb-3"><?php echo DNS1D::getBarcodeHTML('4445645656', 'KIX'); ?></div>
        <div class="mb-3"><?php echo DNS1D::getBarcodeHTML('4445645656', 'RMS4CC'); ?></div>
        <div class="mb-3"><?php echo DNS1D::getBarcodeHTML('4445645656', 'UPCA'); ?></div>        
    </div>
<?php $__env->stopSection(); ?>
