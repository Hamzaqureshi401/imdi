                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td style="text-align:center;">
                           ...
                           @if($p['permission'] == 'Mastercase' || $p['permission'] == 'Product')

                           @if($permission->where('permission', $p['value'])->count() > 0)
                          <a href="{{ route('set.SubPermission', ['permission' => $p['value'] , 'role' => $role->id]) }}" class="btn btn-sm btn-primary">Set Add Update Delete Permission/ {{ $p['value'] }}</a>
                          @endif
