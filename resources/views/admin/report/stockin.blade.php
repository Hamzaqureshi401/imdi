...
@endif   
                ...
                <form id="formmain" class="myform" method="post" action="{{route('gen_stockin')}}" >
                @csrf    
                            <div class="card mb-3">
       ...
       $(document).ready(function(){
            ...
            $('input[name="report"]').change(function () {
                ...
                if(v=="excel")
                {
                    ...
                    myForm.attr("action", "{{ route('gen_stockin_excel') }}");
                }
                if(v=="pdf")
                {
                    myForm.removeAttr("id");
                    ...
                    myForm.attr("action", "{{ route('gen_stockin_pdf') }}");
                }
                ...
                if(v=="view")
                {
                    ...
                    myForm.attr("action", "{{ route('gen_stockin') }}");
                    $('#formmain').ajaxForm({
