...
@endif   
<form id="formmain" class="myform" method="post" action="{{route('gen_inventory')}}" >
   @csrf    
   <div class="card mb-3">
                     ...
                     <div class="position-relative mb-3">
                        ...
                        <div class="form-control">
                           ...
                           <div class="form-check form-check-inline">
                              ...
                              <label class="form-check-label" for="inlineCheckbox1">Un Allocated</label>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <div class="d-block text-end card-footer">
         <input class="submit btn btn-dark " name="submit" value="Generate Report" class="btn btn-info">
         <br>
      </div>
   </div>
</form>
...
<script>
   ...
   //              myForm.attr("action", "{{ route('gen_inventory_excel') }}");
   //          }
   //          if(v=="pdf")
   //          {  
   //              myForm.removeAttr("id");
   ...
   //              myForm.attr("action", "{{ route('gen_inventory_pdf') }}");
   //          }
   ...
   //              myForm.attr("action", "{{ route('gen_inventory') }}");
   //              $('#formmain').ajaxForm({
...
$('.submit').click(function () {
    ...
    if (selectedOption == 'view') {
        ...
        var form = $('#formmain')[0];
        form.action = (selectedOption == 'excel') ? '{{ route('gen_inventory_excel') }}' : '{{ route('gen_inventory_pdf') }}';
