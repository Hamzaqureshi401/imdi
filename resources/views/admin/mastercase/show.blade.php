                                                ...
                                                <div class="col-md-4">
                                                    <div class="col-md-12">
                                                        <div class="position-relative mb-3">
                                                            ...
                                                            <input name="upc" id="upc" value="{{$mc->upc}}"  placeholder="Enter MasterCase UPC" type="text" class="form-control" readonly required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="position-relative mb-3">
                                                            <label for="examplePassword11" class="form-label"> MasterCase Name</label>
                                                            <input name="name" id="pname" value="{{$mc->name}}" placeholder="Enter MasterCase Name" type="text" class="form-control" readonly required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="position-relative mb-3">
                                                                ...
                                                                <input name="length" id="length" value="{{$mc->length}}" placeholder="Enter Length" type="text"readonly class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="position-relative mb-3">
                                                                <label for="examplePassword11" class="form-label"> Height</label>
                                                                <input name="height" id="height" value="{{$mc->height}}" placeholder="Enter Height" type="text" readonly class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="position-relative mb-3">
                                                                <label for="examplePassword11" class="form-label"> Width</label>
                                                                <input name="width" id="width" value="{{$mc->width}}" placeholder="Enter Width" type="text" readonly class="form-control" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="position-relative mb-3">
                                                                ...
                                                                <input name="weight" id="weight" value="{{$mc->weight}}" placeholder="Enter Weight" readonly type="text" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="position-relative mb-3">
                                                                <label for="examplePassword11" class="form-label"> Hi</label>
                                                                <input name="hi" id="hi" placeholder="Enter Hi" value="{{$mc->hi}}" type="text" readonly class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="position-relative mb-3">
                                                                <label for="examplePassword11" class="form-label"> Ti</label>
                                                                <input name="ti" id="ti" placeholder="Enter Ti" value="{{$mc->ti}}" readonly type="text" class="form-control" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="position-relative mb-3">
                                                            ...
                                                            <textarea name="description"  id="desc"class="form-control" readonly>{{$mc->description}}</textarea>
                                                        </div>
                                                    </div>
