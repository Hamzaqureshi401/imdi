...
@section('content')
                    <form class="" id="formmain" method="post" action="{{route('updatereceived')}}">
                    @csrf
                        <div class="row">
                                                            ...
                                                            <div class="widget-content p-0">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="position-relative mb-3">
                                                                            ...
                                                                            <input name="arrival_date" value="{{$rc->arr_date}}" id="arrival_date" type="date" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="position-relative mb-3">
                                                                            ...
                                                                            <input name="order_no" value="{{$rc->order_no}}" id="order_no" type="text" class="form-control" >
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="position-relative mb-3">
                                                                            <label for="examplePassword11" class="form-label"> Container No</label>
                                                                            <input name="container_no" value="{{$rc->container_no}}" id="container_no" type="text" class="form-control" >
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="scrollbar-container ps ps--active-y">
                                                <div class="p-2">
                                                        ...
                                                        <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="position-relative mb-3">
                                                                        ...
                                                                        <select required name="mastercase"   id="mc" class="form-control multiselect-dropdown">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input name="quantity" value="{{$rc->mc_quantity}}"  id="mqty" placeholder="Enter Quantity" value="1"  type="number" min="1" max="100000" class="form-control" >
                                                        ...
                                                        <div class="row" id="mcd">
                                                             {!!getmastercasefull_edit($rc->mcid)!!}
                                                             <div class="col-md-2">
                                                                <div class="position-relative mb-3">
                                                                    <label for="exampleEmail11" class="form-label d-block">Ti</label>
                                                                    <input name="ti" class="form-control" value="{{$rc->ti}}" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="position-relative mb-3">
                                                                    ...
                                                                    <input name="hi" class="form-control" value="{{$rc->hi}}" />
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-ms-12">
                                                                    <table id="protable" class="mb-0 table table-bordered">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="hidden" name="pid[]" value="{{$pd->p_id}}" /><input name="fob[]" class="form-control fob" type="text" value="{{$pd->fob}}" /></td>
                                                                            <td><input name="rp[]" class="form-control rp" type="text" value="{{$pd->retail_price}}" /></td>
                                                                            <td><input name="ed[]" class="form-control ed" type="date" value="{{$pd->expiry}}" /></td>
                                                                        </tr>
                                                                        @endforeach
